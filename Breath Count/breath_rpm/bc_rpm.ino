...
unsigned long lastBreathTime2 = 0;
int breathCount = 0;
...
void loop() {
  ...
  if (smoothedWaveform > BREATH_THRESHOLD && (millis() - lastBreathTime > BREATH_DEBOUNCE)) {
    breathCount++;
    lastBreathTime2 = millis()-lastBreathTime;
  ...
  Serial.print(",");
  Serial.print(breathCount);     // Red Line: Step counter
  Serial.print(", gap:");
  Serial.print(lastBreathTime2);
  Serial.print(", rpm:");
  Serial.println(60000.0/lastBreathTime2);
